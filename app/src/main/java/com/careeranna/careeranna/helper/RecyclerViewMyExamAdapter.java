...
public class RecyclerViewMyExamAdapter extends RecyclerView.Adapter<RecyclerViewMyExamAdapter.ViewHolder>{
    ...
    public RecyclerViewMyExamAdapter(ArrayList<String> names, ArrayList<String> urls, Context mContext) {
        this.names = names;
        this.urls = urls;
